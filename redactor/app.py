...
class Login(QDialog):
    def __init__(self, directory):
        ...
        layout.addWidget(label("Only the local creator’s account password unlocks their databases. Imported copies belong to the importing analyst. Use at least 12 characters; there is no password reset or recovery service.", "notice", True))
...
class MainWindow(AnalystActions, QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        self.source.document().clearUndoRedoStacks()
        self.output.clear()
        self.output.document().clearUndoRedoStacks()
        self.table.blockSignals(True)
